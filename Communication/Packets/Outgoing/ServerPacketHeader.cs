...
public static class ServerPacketHeader
{
    ...
    public const uint RpRetainChatPrefixComposer = 3986;
    public const uint RpBirthdayComposer = 3987;
    public const uint RpCalendarComposer = 3993;
    public const uint RpNotesComposer = 3998;
    ...
    public const uint RpSitchSearchComposer = 4138;
    public const uint RpSitchTrendingComposer = 4139;
    // Internal 439xx / wire 39xx - see the album note in ClientPacketHeader.
